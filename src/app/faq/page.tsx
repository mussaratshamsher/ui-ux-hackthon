...
<div className='grid grid-cols-2 mt-3 md:mt-10 md:m-10 gap-2 md:gap-5'>
    ...
    <div className=' bg-green-200'>
        <h1 className='p-2'> <b>How we serve food? </b><span className='ml-96'>+</span></h1>
<p className='p-2'>
...
a type specimen book. It has survived not only five centuries, 
      ...
      <div className=' bg-green-200'>
        <h1 className='p-2'> <b>How can get in touch with you? </b><span className='ml-96'>-</span></h1>
<p className='p-2'>
Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's 
standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make 
a type specimen book. It has survived not only five centuries, 
...
{/* grid 3  */}
<div className=' bg-green-200'>
        <h1 className='p-2'> <b>How is our food quality? </b><span className='ml-96'>+</span></h1>
<p className='p-2'>
Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's 
standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make 
a type specimen book. It has survived not only five centuries, 
...
{/* grid 4  */}
<div className='bg-green-200'>
        <h1 className='p-2'> <b>What will be delivered? And When? </b><span className='ml-96'>+</span></h1>
<p className='p-2'>
Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's 
standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make 
a type specimen book. It has survived not only five centuries, 
    ...
    {/* grid 5  */}
<div className='bg-green-200'>
        <h1 className='p-2'> <b>How do we give home delivery? </b><span className='ml-96'>+</span></h1>
<p className='p-2'>
Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's 
standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make 
a type specimen book. It has survived not only five centuries, 
    ...
    {/* grid 6 */}
<div className='bg-green-200'>
        <h1 className='p-2'> <b>Is this resturant 24 hours open? </b><span className='ml-96'>+</span></h1>
<p className='p-2'>
Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's 
standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make 
a type specimen book. It has survived not only five centuries, 
