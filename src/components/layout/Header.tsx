        ...
        <div >
          ...
          <b className="text-2xl ">F<span id='clr'>oo</span>dtuck <i className='bx bx-bowl-hot text-green-600 text-2xl'></i>.....</b>
           Enjoy Delicious Food <Utensils size={32} color="#15b736" strokeWidth={2.75} /></h1>
            ...
            <div className="w-full  md:h-20 h-10 flex flex-row  backdrop-blur-sm justify-between md:mt-5 mt-3 p-5"> 

                {/* grid 1  */}
                <h1 className='font-bold md:text-4xl text-2xl md:ml-32'>F<span id='clr'>oo</span>dtuck</h1>  
