...
<div className='grid grid-cols-2 md:mt-32 mt-20 md:ml-36 ml-3 md:gap-5 gap-2'>
   ...
   <div className='animate__animated animate__zoomIn mt-5'>
    <Image src={abthome1} alt='' width={500} height={500} className='md:w-[250px] md:h-[200px] w-[100px] h-[80px]'/></div>
   <div className='animate__animated animate__zoomIn row-span-2'>
    <Image src={abthome3} alt='' width={500} height={500} className='md:w-[250px] md:h-[300px] w-[100px] h-[100px]'/></div>
   </div>
